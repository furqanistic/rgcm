...
export default function AllBobBookingsTable() {
  const navigate = useNavigate()

  const { data, status } = useQuery('stats-all-bob-bookings', async () => {
    const res = await axiosInstance.get(`/booking/bob-booking`)
